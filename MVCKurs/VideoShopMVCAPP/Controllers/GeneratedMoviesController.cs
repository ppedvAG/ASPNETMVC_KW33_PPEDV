...
{
    public class GeneratedMoviesController : Controller
    {
        private readonly MovieDbContext _context;

        public GeneratedMoviesController(MovieDbContext context)
        {
            _context = context;
        }
        ...
        // GET: GeneratedMovies/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: GeneratedMovies/Create
